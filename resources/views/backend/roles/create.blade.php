  ...
  <form action="{{ route($controllerName . '.store') }}" method="POST" autocomplete="off">
    ...
    <div class="form-row">
      ...
      <div class="form-group col-md-8">
        ...
        <input type="text" name='display_name' class="form-control" value='{{ old('display_name') }}' id="display_name" placeholder="Mô tả vai trò">
        @error('display_name')
          <div class="error-text">
            {{ $message }}
          </div>
          ...
          <div class="card h-100">
            <div class="card-header bg-info text-white">
              <div class="checkbox checkbox-success">
                  <input id="permission{{$permission->id}}" class="js-permission" type="checkbox" name="permission_id[]" value="{{$permission->id}}">
            ...
            <div class="card-body">
              @foreach($permission->permissionsChildren as $children)
                <div class="checkbox checkbox-success" >
                  <input id="permission{{$children->id}}" class="permission-children" type="checkbox" name="permission_id[]" value="{{$children->id}}" disabled>
