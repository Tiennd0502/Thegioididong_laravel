  ...
  <div class="row mb-2">
    <div class="col-10 ">
      <form class="form-inline my-2 my-lg-0" action="" method="GET" id="js-ajax-filter">
        @csrf
        <input class="form-control mr-2" value='{{ \Request::get('name')}}' type="text" name="name" id="js-name" placeholder="Tìm kiếm theo tên" style="width: 30%">

        <select id="js-category-id" data-name="search" name="category_id" class="mr-2">
        ...
        <select id="js-brand-id" name="brand_id" class="mr-2" value=''>
        ...
        <div class="form-check mr-2">
          <input class="form-check-input" type="checkbox" value="1" name="hot" id="hot" {{( \Request::get('hot') == 1 ) ? 'checked' :'' }}>
          <label class="form-check-label" for="hot">
            Hot
          </label>
        </div>
        <button data-position="filter-admin" class="btn btn-dark my-2 my-sm-0" type="submit"><i class="fas fa-search"></i></button>
      </form>
    </div>
