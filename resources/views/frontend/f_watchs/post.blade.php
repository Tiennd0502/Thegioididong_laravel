...
<div class="news-block-watch">
  ...
  <div class="video js-video ">
    <a href="">
      <img class="lazyload" loading="lazy" data-src="{{ asset('images/maxresdefault (1).jpg') }}" alt="">
    </a>
    <div class="video-list">
      <a href="">
        <img class="lazyload" loading="lazy" data-src="{{ asset('images/mqdefault (2).jpg') }}" alt="">
        <div>
  ...
  <div class="news js-news" style="display: none">
    <a href="">
      <img class="lazyload" loading="lazy" data-src="{{ asset('images/laptopaceraspirea515535112i5_800x450-600x400.jpg') }}" alt="">
    ...
    <div class="news-list">
      <a href="">
        <img class="lazyload" loading="lazy" data-src="{{ asset('images/laptop-3m_800x450-600x400.jpg') }}" alt="">
        <div>
      ...
      <a href="">
        <img class="lazyload" loading="lazy" data-src="{{ asset('images/th_800x450-600x400.jpg') }}" alt="">
        <div>
      ...
      <a href="">
        <img class="lazyload" loading="lazy" data-src="{{ asset('images/t_800x450-600x400.jpg') }}" alt="">
        <div>
  ...
  <div class="news tutorial js-tutorial" style="display: none">
    <a href="">
      <img class="lazyload" loading="lazy" data-src="{{ asset('images/cach-cap-quyen-pop-imap-cho-outlook-gmail-yahoo-icloud-thumb-01.jpg') }}" alt="">
    ...
    <div class="news-list">
      <a href="">
        <img class="lazyload" loading="lazy" data-src="{{ asset('images/cach-them-tai-khoan-email-khac-vao-gmail-tren-may-tinh-thumb.jpg') }}" alt="">
        <div>
      ...
      <a href="">
        <img class="lazyload" loading="lazy" data-src="{{ asset('images/cach-xem-mat-khau-wifi-da-luu-tren-dien-thoai-may-tinh-don-thumb.jpg') }}" alt="">
        <div>
